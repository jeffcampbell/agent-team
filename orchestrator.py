...
class StationManager:
    ...
    def _check_spec_sla(self):
        ...
        for train in self.trains:
            ...
            if elapsed < config.SPEC_SLA_SECONDS + 60:  # 60s grace period
                continue
    ...
    def _check_checkpoint_sla(self):
        ...
        for train in self.trains:
            ...
            if idle_for < config.CHECKPOINT_SLA_SECONDS + 60:  # 60s grace period
                continue
    ...
    def _check_idle_sla(self):
        ...
        has_backlog = bool(self._backlog_specs())
